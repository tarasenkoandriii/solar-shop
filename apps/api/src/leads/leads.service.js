...
var LeadsService = function () {
    ...
    var LeadsService = _classThis = /** @class */ (function () {
        function LeadsService_1(prisma, notify) {
            this.prisma = prisma;
            this.notify = notify;
        }
        LeadsService_1.prototype.create = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var lead;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.prisma.client.lead.create({
                                data: {
                                    name: dto.name,
                                    phone: dto.phone,
                                    comment: dto.comment,
                                    source: (_a = dto.source) !== null && _a !== void 0 ? _a : db_1.LeadSource.WEB,
                                },
                            })];
                        case 1:
                            lead = _b.sent();
                            return [4 /*yield*/, this.notify.notifyLead(lead)];
                        case 2:
                            _b.sent();
        ...
        LeadsService_1.prototype.findAllForAdmin = function () {
            return this.prisma.client.lead.findMany({ orderBy: { createdAt: 'desc' } });
        };
        LeadsService_1.prototype.updateStatus = function (id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var lead;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.client.lead.findUnique({ where: { id: id } })];
                        case 1:
                            lead = _a.sent();
                            if (!lead)
                                throw new common_1.NotFoundException('Lead not found');
                            return [2 /*return*/, this.prisma.client.lead.update({ where: { id: id }, data: { status: dto.status } })];
                    }
                });
            });
        };
