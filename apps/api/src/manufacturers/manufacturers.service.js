...
var ManufacturersService = function () {
    ...
    var ManufacturersService = _classThis = /** @class */ (function () {
        function ManufacturersService_1(prisma) {
            this.prisma = prisma;
        }
        ManufacturersService_1.prototype.findAll = function () {
            return this.prisma.client.manufacturer.findMany({ orderBy: { name: 'asc' } });
        };
        ManufacturersService_1.prototype.create = function (dto) {
            return this.prisma.client.manufacturer.create({ data: dto });
        };
        ManufacturersService_1.prototype.update = function (id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [2 /*return*/, this.prisma.client.manufacturer.update({ where: { id: id }, data: dto })];
                    }
                });
            });
        };
        ManufacturersService_1.prototype.remove = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getOr404(id)];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, this.prisma.client.manufacturer.delete({ where: { id: id } })];
                        case 2:
                            _a.sent();
        ...
        ManufacturersService_1.prototype.getOr404 = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var item;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.client.manufacturer.findUnique({ where: { id: id } })];
                        case 1:
                            item = _a.sent();
                            if (!item)
