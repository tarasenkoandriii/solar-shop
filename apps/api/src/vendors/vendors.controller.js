...
var VendorsController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(db_1.UserRole.ADMIN), (0, common_1.Controller)('admin/vendors')];
    ...
    var VendorsController = _classThis = /** @class */ (function () {
        function VendorsController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        VendorsController_1.prototype.findAll = function () {
            return this.service.findAll();
        };
        VendorsController_1.prototype.create = function (dto) {
            return this.service.create(dto);
        };
        VendorsController_1.prototype.update = function (id, dto) {
            return this.service.update(id, dto);
        };
        VendorsController_1.prototype.remove = function (id) {
