...
var RateLimitService = function () {
    ...
    var _classThis;
    var RateLimitService = _classThis = /** @class */ (function () {
        function RateLimitService_1(prisma) {
            this.prisma = prisma;
        }
        RateLimitService_1.prototype.checkAndIncrement = function (key, limit, windowSeconds) {
            return __awaiter(this, void 0, void 0, function () {
                var windowStart, entry;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            windowStart = new Date(Math.floor(Date.now() / (windowSeconds * 1000)) * windowSeconds * 1000);
                            return [4 /*yield*/, this.prisma.client.rateLimitEntry.upsert({
                                    where: { key_windowStart: { key: key, windowStart: windowStart } },
                                    create: { key: key, windowStart: windowStart, count: 1 },
        ...
        RateLimitService_1.prototype.cleanupOlderThan = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.prisma.client.rateLimitEntry.deleteMany({ where: { windowStart: { lt: cutoff } } })];
                        case 1:
                            result = _a.sent();
